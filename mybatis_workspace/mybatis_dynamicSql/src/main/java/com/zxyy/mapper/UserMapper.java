...
public interface UserMapper {
    ...
    void save666(SysUser sysUser);

    SysUser selectByIdOrUsername(SysUser sysUser);

    List<SysUser> selectByUser2(SysUser sysUser);

    void updateByIdSelective2(SysUser sysUser);

    List<SysUser> selectByIdList(Map<String,Object> map);

    /**
     * 演示使用foreach批量插入
     * @param list
     */
    void insertMany(List<SysUser> list);

    /**
     * 使用foreach实现动态修改
     * @param map
     */
    void updateByForeach(Map<String,Object> map);
}
